#!/bin/bash
path2rosetta='/home/maria/Rosetta'
...
$path2rosetta/main/source/bin/rosetta_scripts.linuxgccrelease -parser:protocol  native.xml -s 3gso.pdb  -overwrite -ignore_zero_occupancy false > native.log
...
while read line; do
	...
	$path2rosetta/main/source/bin/rosetta_scripts.linuxgccrelease -parser:protocol  test.xml -s 3gso.pdb  -overwrite -ignore_zero_occupancy false > $j.log
...
python3 Frust_Post_public.py 100 -2.5 0.5 $2 9 0 Function1 -1.5 0.5
